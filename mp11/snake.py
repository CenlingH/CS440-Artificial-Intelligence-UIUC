...
class SnakeEnv:
    def __init__(self, snake_head_x, snake_head_y, food_x, food_y,
        ...
        self.game = Snake(snake_head_x, snake_head_y, food_x,
                          food_y, display_width, display_height, rock_x, rock_y)
        self.render = False
        if random_seed:
    ...
    def draw(self, environment, points, dead):
        ...
        text_surface = self.font.render(
            "Points: " + str(points), True, utils.BLACK)
    ...
    def display(self):
        ...
        self.display = pygame.display.set_mode(
            (self.game.display_width * LENGTH_FACTOR, self.game.display_height * LENGTH_FACTOR), pygame.HWSURFACE)
