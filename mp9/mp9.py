...
def main(args):
    ...
    L, predicted_labels, net = p.fit(
        train_set, train_labels, dev_set, args.epochs)
    ...
    accuracy, conf_m = compute_accuracies(
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='CS440/ECE448 MP9: Neural Nets and PyTorch')
